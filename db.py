...
token = '7604313176:AAEkNRxZ0NQmTaqTThh_wrrL5dKu_eTaab0'
bot_name = 'LEGAL 24 CORE'
bot_username = '@legalvpsnewddosbot'
owner_username = '@LegalMods'
channel_username = '@LegalMods'
